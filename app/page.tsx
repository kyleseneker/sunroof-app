      ...
      <div className="min-h-screen bg-black safe-top safe-bottom">
        ...
        <div className="flex justify-between items-center p-6 pb-4">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-full bg-zinc-800 shimmer-bg" />
            <div className="w-16 h-3 rounded bg-zinc-800 shimmer-bg" />
          </div>
          <div className="flex gap-2">
            <div className="w-10 h-10 rounded-full bg-zinc-800 shimmer-bg" />
            <div className="w-10 h-10 rounded-full bg-zinc-800 shimmer-bg" />
            <div className="w-10 h-10 rounded-full bg-zinc-800 shimmer-bg" />
          </div>
        </div>
        ...
        <div className="px-6">
          {/* Greeting skeleton */}
          <div className="w-32 h-4 rounded bg-zinc-800 shimmer-bg mb-6" />
          
          {/* Section label skeleton */}
          <div className="flex items-center gap-2 mb-4">
            <div className="w-2 h-2 rounded-full bg-zinc-800" />
            <div className="w-24 h-3 rounded bg-zinc-800 shimmer-bg" />
          </div>
          
          {/* Journey card skeleton */}
          <div className="rounded-[28px] bg-zinc-900 border border-zinc-800 p-6 h-48 shimmer-bg" />
        </div>
      </div>
    );
  }
  ...
  if (fetchError && activeJourneys.length === 0) {
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-zinc-500 mb-6 max-w-xs">Unable to load your journeys. Please check your internet connection and try again.</p>
        <button 
          onClick={() => {
            setLoading(true);
