      ...
      <main className="flex-1 overflow-y-auto scrollbar-hide">
        <div className="max-w-2xl mx-auto p-6">
          ...
          <div className="space-y-8 text-[var(--fg-muted)] leading-relaxed">
            <section>
              <h2 className="text-xl font-semibold text-[var(--fg-base)] mb-3">Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--fg-base)] mb-3">Description of Service</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--fg-base)] mb-3">User Content</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--fg-base)] mb-3">Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--fg-base)] mb-3">Disclaimer</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--fg-base)] mb-3">Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--fg-base)] mb-3">Changes to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--fg-base)] mb-3">Contact</h2>
              <p>
                For questions about these Terms, contact us at{' '}
                <a href="mailto:hello@getsunroof.com" className="text-[var(--color-accent)] hover:underline">
