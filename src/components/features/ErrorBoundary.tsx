        ...
        <div className="fixed inset-0 bg-gradient-to-br from-amber-950 via-orange-950 to-slate-950 flex flex-col items-center justify-center p-8 text-center safe-top safe-bottom">
          ...
          <div className="relative z-10">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-full font-medium hover:opacity-90 active:scale-[0.98] transition-all shadow-lg shadow-orange-500/20 mx-auto"
            >
              <RefreshCw className="w-4 h-4" />
              Try Again
            </button>
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <pre className="mt-8 p-4 bg-black/30 backdrop-blur-md border border-white/10 rounded-xl text-left text-xs text-red-400 max-w-md overflow-auto">
